metadata {
	...
	definition (name: "Aeon Outlet - Watts", namespace: "Bart", author: "Bart") {
	...
	// tile definitions
	tiles {
		valueTile("energy", "device.power", decoration: "flat", canChangeIcon: true) {
			state "default", label:'${currentValue} Watts'
		}
		...
		main "energy","switch"
		details(["energy","switch","refresh","configure"])
	}
}
...
def configure() {
	delayBetween([
		zwave.configurationV1.configurationSet(parameterNumber: 101, size: 4, scaledConfigurationValue: 4).format(),   // energy in kWh
